...
class ColorResources {
  static Color getTextColor1() {
    return Get.isDarkMode ? Colors.green : const Color(0xFF85A802);
  }
  ...
  static Color getPrimaryTextColor() {
    return Get.isDarkMode ? const Color(0xFF8dbac3) : const Color(0xFF34C434);
  }
  ...
  static Color getBlackColor() {
    return Get.isDarkMode ? const Color(0xFFFFFFFF) : const Color(0xFF000000);
  }
  ...
  static Color getTransactionTrailingColor() {
  ...
  static Color primaryColor = const Color(0xFF85A802);
